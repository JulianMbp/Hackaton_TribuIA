  ...
  return (
    <div className="min-h-screen bg-neutral-50 dark:bg-neutral-950 transition-colors duration-500">
      ...
      <main className="p-4 md:p-8 bg-neutral-50 dark:bg-neutral-950 transition-colors duration-500">
        ...
        {/* Info Message */}
        <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg max-w-[1600px] mx-auto transition-colors duration-300">
          <p className="text-sm text-blue-800 dark:text-blue-300 text-center transition-colors duration-300">
